...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> VAS CP Log Viewer</h1>
      {{-- <p class="text-muted"><i>by Zarif</i></p> --}}
      ...
      <div> <a href="{{route('operation.user-list')}}" type="submit" class="btn btn-inverse-primary btn-fw btn-inline">Go back to User List
      </a> </div>
